        ...
        if(this.state.name.match(alpha)){
            ...
            if(this.state.email.match(email)){
                ...
                if(this.state.number.match(phoneno)){
                   ...
                   var ref =  Fire.database().ref('users/'+this.props.uid+'/Projects/'+this.props.pid+'/rooms/'+this.props.rid+'/analytics').push({
                    ...
                    localStorage.setItem("rid",this.props.rid);
                    
                    localStorage.setItem("guestkey",ref.key);
                    localStorage.setItem("name",this.state.name);
                    localStorage.setItem(this.props.rid,false);
                    this.setState({
                        redirect:true
                    })
                }
        ...
        <div style={{background: "#eeeeee"}} className="login_container row">
            ...
            <div style={{padding:"0", textAlign:'center', width:"100%"}} className="col-sm-7 col-xs-12">
                ...
                <div className="BlueBG">   
                    <h1 className="Welcome-to-Prop-VR" >Your are joining a virtual tour session</h1>
                    <div style={{margin:0, padding:0, width:'100%'}} class="card project_det_background">    
                          <div style={{padding: "0px"}} className="card-body d-flex flex-row">
                            <img src={this.state.img} width="81px" alt="avatar" />
                            <div style={{width: "100%"}}>
                                <h4 className="card-title project_heading" style={{textAlign:"center"}}>{this.props.pid}</h4>
                                <div style={{display:this.state.info_details==true?'flex':'none'}} className="card-text flex-row project_icon_content">
                                    <div className="col">
                                    <span>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
