        ...
        <div style={{height: '72px', flexWrap: 'nowrap'}} className="row">
          <div className="content_padding dropup">
            <button id="menu_bar" type="button" className="menu_option dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <span id="menu_bar_up" style={{display: 'block'}}>
              ...
              <span style={{display: 'none', transform: 'translateY(2px)'}} id="menu_bar_down">
          ...
          <div className="content_padding">
            ...
            <button onclick="offvideo(this);" onClick={this.props.videoaction} className="menu_option" style={{background: '#fff'}}>
              <svg id="video_on" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={24} height={24} viewBox="0 0 24 24">
                <defs>
              ...
              <svg style={{display: 'none'}} id="video_off" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24">
          ...
          <div id="MultiCarousel" className="MultiCarousel owl-carousel owl-loaded owl-drag">
            <div className="owl-stage-outer"><div className="owl-stage" style={{left: '0px', width: '2045px'}}><div className="owl-item active" style={{width: '175.9px', marginRight: '10px'}}><div className="MultiCarousel-inner">  
                    <div className="item item_active">
                      <div className="pad15">
                        <p className="slider_name">Living room</p>
                      </div>
                    </div> 
                  </div></div><div className="owl-item active" style={{width: '175.9px', marginRight: '10px'}}><div className="MultiCarousel-inner">  
                    <div className="item">
                      <div className="pad15">
                        <p className="slider_name">Kitchen</p>
                      </div>
                    </div> 
                  </div></div><div className="owl-item active" style={{width: '175.9px', marginRight: '10px'}}><div className="MultiCarousel-inner">  
                    <div className="item">
                      <div className="pad15">
                        <p className="slider_name">Master bedroom</p>
                      </div>
                    </div>
                  </div></div><div className="owl-item active" style={{width: '175.9px', marginRight: '10px'}}><div className="MultiCarousel-inner"> 
                    <div className="item">
                      <div className="pad15">
                        <p className="slider_name">Kids bedroom</p>
                      </div>
                    </div> 
                  </div></div><div className="owl-item" style={{width: '175.9px', marginRight: '10px'}}><div className="MultiCarousel-inner">  
                    <div className="item">
                      <div className="pad15">
                        <p className="slider_name">Work room</p>
                      </div>
                    </div>
                  </div></div><div className="owl-item" style={{width: '175.9px', marginRight: '10px'}}><div className="MultiCarousel-inner">  
                    <div className="item">
                      <div className="pad15">
                        <p className="slider_name">Guest room</p>
                      </div>
                    </div>
                  </div></div><div className="owl-item" style={{width: '175.9px', marginRight: '10px'}}><div className="MultiCarousel-inner"> 
                    <div className="item">
                    ...
                    <div className="item">
                      <div className="pad15">
                        <p className="slider_name">Guest room1</p>
                      </div>
                    </div> 
                  </div></div><div className="owl-item" style={{width: '175.9px', marginRight: '10px'}}><div className="MultiCarousel-inner">  
                    <div className="item">
