...
if(this.state.redirect){
    ...
    <div  className="login_container container d-none d-sm-block">
                ...
                <div className="JoiningForm">
                    <div style={{margin:"0",padding:"0",paddingTop: "10px"}} className="row">
                        <div style={{margin:0, padding:0, width:'100%'}} class="card project_det_background">    
                         ...
                         <h4 className="card-title project_heading">{this.props.match.params.pid}</h4>
                              <div style={{display:this.state.info_details==true?'flex':'none', paddingLeft:'0px'}} className="card-text flex-row project_icon_content">
                                <div className="col">
                                  <span>
